...
function M.parse(arg)
    ...
    cmd:option('-cache', './features-combination/checkpoint/', 'subdirectory in which to save/log experiments')
    cmd:option('-data', '../724', 'Home of ImageNet dataset')
    ...
    ---------- Model options ----------------------------------
    cmd:option('-netType',     'svm-classifier', '')
    cmd:option('-retrain',     'none', 'provide path to model to retrain with')
    cmd:option('-optimState',  'none', 'provide path to an optimState to reload from')
    cmd:option('-channels',  '5', '')
    cmd:option('-features',  '512', '')
