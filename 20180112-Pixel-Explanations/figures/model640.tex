...
\tikzstyle{input} = [rectangle, rounded corners, minimum width=3cm, minimum height=1cm,text centered, draw=black, fill=green!30]
\tikzstyle{output} = [rectangle, rounded corners, minimum width=3cm, minimum height=1cm,text centered, draw=black, fill=yellow!30]
...
\begin{document}
		\begin{tikzpicture}[node distance=1.5cm]
				...
				\node (linear) [block, below of=av15, align=center] {Linear \\ (Layer 16)};	% 1x1
				\node (output) [output, below of=linear] {Output};	
